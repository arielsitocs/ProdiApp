...
function UpdateProducts({ state, setUpdateState, id, name, category, weight, price, description, productImage, updateProductInList = { updateProductInList } }) {
    ...
    const handleUpdate = async (e) => {
        ...
        // Actualiza la lista de productos en el la lista de productos del componente padre de inmediato //
